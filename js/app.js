...
var game = new Phaser.Game(900,900, Phaser.CANVAS, 'game');
...
var game = new Phaser.Game(864,896,Phaser.AUTO, 'Put A Steak In Trump');

var TrumpGame = function(game){
    this.map = null;
    this.layer = null;
    this.trump = null;
...
game.state.add('Game', TrumpGame, true);*/
